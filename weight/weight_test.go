...
func TestAdminLayoutWeight1_Output(t *testing.T) {
	...
	//主体
	adminLayoutBodyWeight.Children = append(adminLayoutBodyWeight.Children, &ContainerWeight{
		IsFluid: false,
		FullStateWeight: FullStateWeight{Children: []Weight{
			&RowWeight{FullStateWeight{
				Children: []Weight{
					&ColWeight{
